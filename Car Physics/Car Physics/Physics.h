...
namespace PE
{
	namespace Components
	{
		struct Physics: public Component
		{
			...
			static bool BoxBoxCollision(PhysicsComponent *Collider1, PhysicsComponent *Collider2);
			static bool SphereBoxCollision(PhysicsComponent *Collider1, PhysicsComponent *Collider2);
			static bool SphereSphereCollision(PhysicsComponent *Collider1, PhysicsComponent *Collider2);
			static bool SphereCarCollision(PhysicsComponent *Collider1, PhysicsComponent *Collider2);
